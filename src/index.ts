...
const PORT = 3000;
const ANTHROPIC_API_KEY = ""; // replace with your key
const DEFAULT_SYSTEM = "You are a text analysis assistant. Analyze the user's input and call the format_response tool with a concise summary and exactly 3 key action items extracted directly from the text. Do not invent or infer anything not explicitly stated.";
